...
const SalesReport = React.lazy(() => import('./views/pages/SalesReport'))
...
const routes = [
  ...
  { path: '/vendor-list', name: 'VendorList', element: VendorList },
  { path: '/customer-list/:vendorId', name: 'CustomerList', element: CustomerList },
